# api documentation for  [knex (v0.12.9)](https://github.com/tgriesser/knex#readme)  [![travis-ci.org build-status](https://api.travis-ci.org/npmdoc/node-npmdoc-knex.svg)](https://travis-ci.org/npmdoc/node-npmdoc-knex)
...
#### [module knex.migrate](#apidoc.module.knex.migrate)
...
1.  [function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>status (config)](#apidoc.element.knex.migrate.prototype.status)
...
#### <a name="apidoc.element.knex.migrate.prototype._ensureFolder"></a>[function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>_ensureFolder ()](#apidoc.element.knex.migrate.prototype._ensureFolder)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.migrate.prototype._generateStubTemplate"></a>[function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>_generateStubTemplate ()](#apidoc.element.knex.migrate.prototype._generateStubTemplate)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.migrate.prototype._runBatch"></a>[function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>_runBatch (migrations, direction)](#apidoc.element.knex.migrate.prototype._runBatch)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.migrate.prototype.rollback"></a>[function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>rollback (config)](#apidoc.element.knex.migrate.prototype.rollback)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.migrate.prototype.setConfig"></a>[function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>setConfig (config)](#apidoc.element.knex.migrate.prototype.setConfig)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.migrate.prototype.status"></a>[function <span class="apidocSignatureSpan">knex.migrate.prototype.</span>status (config)](#apidoc.element.knex.migrate.prototype.status)
- description and source-code
```javascript
...
# <a name="apidoc.module.knex.seed"></a>[module knex.seed](#apidoc.module.knex.seed)

#### <a name="apidoc.element.knex.seed.seed"></a>[function <span class="apidocSignatureSpan">knex.</span>seed (knex)](#apidoc.element.knex.seed.seed)
- description and source-code
```javascript
function Seeder(knex) {
  this.knex = knex;
...
# <a name="apidoc.module.knex.seed.prototype"></a>[module knex.seed.prototype](#apidoc.module.knex.seed.prototype)

#### <a name="apidoc.element.knex.seed.prototype._absoluteConfigDir"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_absoluteConfigDir ()](#apidoc.element.knex.seed.prototype._absoluteConfigDir)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype._ensureFolder"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_ensureFolder ()](#apidoc.element.knex.seed.prototype._ensureFolder)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype._generateStubTemplate"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_generateStubTemplate ()](#apidoc.element.knex.seed.prototype._generateStubTemplate)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype._listAll"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_listAll ()](#apidoc.element.knex.seed.prototype._listAll)
- description and source-code
```javascript
_listAll = function () {
    var ret = new Promise(INTERNAL);
...
#### <a name="apidoc.element.knex.seed.prototype._runSeeds"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_runSeeds (seeds)](#apidoc.element.knex.seed.prototype._runSeeds)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype._seedData"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_seedData ()](#apidoc.element.knex.seed.prototype._seedData)
- description and source-code
```javascript
_seedData = function () {
...
#### <a name="apidoc.element.knex.seed.prototype._validateSeedStructure"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_validateSeedStructure (name)](#apidoc.element.knex.seed.prototype._validateSeedStructure)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype._waterfallBatch"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_waterfallBatch (seeds)](#apidoc.element.knex.seed.prototype._waterfallBatch)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype._writeNewSeed"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>_writeNewSeed (name)](#apidoc.element.knex.seed.prototype._writeNewSeed)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype.make"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>make (name, config)](#apidoc.element.knex.seed.prototype.make)
- description and source-code
```javascript
...
#### <a name="apidoc.element.knex.seed.prototype.run"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>run ()](#apidoc.element.knex.seed.prototype.run)
- description and source-code
```javascript
run = function () {
    var ret = new Promise(INTERNAL);
...
#### <a name="apidoc.element.knex.seed.prototype.setConfig"></a>[function <span class="apidocSignatureSpan">knex.seed.prototype.</span>setConfig (config)](#apidoc.element.knex.seed.prototype.setConfig)
- description and source-code
```javascript
